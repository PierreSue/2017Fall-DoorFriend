...
face_recognizer.write("recognizer.xml");
...
cv2.imwrite("s1.jpg",cv2.resize(predicted_img1, (400, 500)))
cv2.imwrite("s2.jpg",cv2.resize(predicted_img2, (400, 500)))
cv2.imwrite("error.jpg",cv2.resize(predicted_img3, (400, 500)))
